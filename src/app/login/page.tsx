      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <svg className="brand-icon" width="48" height="48" viewBox="0 0 32 32" fill="none" style={{ margin: '0 auto 16px' }}>
            <rect x="2" y="2" width="28" height="28" rx="6" fill="url(#login-brand-grad)" />
            ...
            <defs>
              <linearGradient id="login-brand-grad" x1="2" y1="2" x2="30" y2="30">
                <stop stopColor="#5B7C99" />
                <stop offset="1" stopColor="#3D5A80" />
              </linearGradient>
            </defs>
          </svg>
          <h1 style={{ fontSize: '1.5rem', fontWeight: '700', margin: '0 0 8px 0', color: 'var(--blue-800)' }}>Welcome Back</h1>
          <p style={{ color: 'var(--color-text-muted)', margin: 0, fontSize: '0.85rem' }}>Sign in to your AssetHub dashboard</p>
        </div>
        ...
        <form action={login} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
              <label htmlFor="password" style={{ fontSize: '0.85rem', color: 'var(--color-text-secondary)' }}>Password</label>
